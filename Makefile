...
PROJECT_NAME := opentelekomcloud-crossplane-provider
PROJECT_REPO := github.com/vladimirvshivkov/opentelekomcloud-crossplane-provider

export TERRAFORM_VERSION := 1.2.1

export TERRAFORM_PROVIDER_SOURCE := opentelekomcloud/opentelekomcloud
export TERRAFORM_PROVIDER_VERSION := v1.31.6
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-opentelekomcloud
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://releases.hashicorp.com/terraform-provider-opentelekomcloud/1.31.6
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-opentelekomcloud_1.31.6
...
xpkg.build.upjet-provider-opentelekomcloud: do.build.images
